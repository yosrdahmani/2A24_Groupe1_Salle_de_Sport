...
if (isset($_GET['id'])){
 ...
 $PromotionC=new PromotionC();
    $result=$PromotionC->recuperer_promotion($_GET['id']);

    foreach($result as $row){

         $val_promation=$row->val_promation;
    }
}
?>
...
<body>
  ...
  <div class="col-xs-6 col-md-3">
        ...
        <h5>Afficher Promotion </h5>
     <a class="btn btn-warning"  href="AfficherPromotion.php">Retour</i></a>
            </div>
          </div>
        </div>
  ...
  <div class="col-xs-6 col-md-3">
       ...
       <form  name="myForm" method="POST" action="ModifierPromotionC.php" >
                
                           <div class="form-group">
                               <input class="form-control"  id="val_promation" name="val_promation" value="<?php echo $val_promation; ?>" type="number" placeholder="val_promation"   />
...
function validateForm() {
 ...
 var val_promation = document.forms["myForm"]["val_promation"].value;
    ...
    alert("val_promation ne doit pas etre negative");
    return false;
  }
      if (val_promation == "" ) {

    alert("val_promation vide");
    return false;
  }
 if (val_promation >=100 ) {

    alert("val_promation ne doit pas etre superieur a 100%");
    return false;
  }
